        ...
        <form method="POST" enctype="multipart/form-data">
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="book_id" id="input-book-id" placeholder="Nhập mã sách" required>
                </div>
                <div class="form-group col-md-6">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="input-desc" name="description" placeholder="Nhập mô tả" required></textarea>
            </div>
            <div class="form-group">
                <label for="input-price">Giá</label>
                <input type="text" class="form-control" name="price" id="input-price" placeholder="Nhập giá">
            </div>
            <div class="form-group">
